							...
							<div class="row" data-animation="fadeInUp">
							  <div class="col-md-4 col-md-offset-1">
									<div class="normal-signin"> 
									  ...
									  <form id="form" method="post" action="workerlogin">
									  <div class="form-main">
										  <div class="form-group">
												<div class="un-wrap">
													<i class="fa fa-user"></i>
											  			<input type="text" class="form-control" placeholder="name" name="workerName" id="workerName" required="required">
												</div>
												<div class="pw-wrap">
													<i class="fa fa-lock"></i>
											  			<input type="password" class="form-control" placeholder="Password" name="workerPassword" id="workerPassword" required="required">
												</div>
								...
								<div class="col-md-4">
									<div class="sns-signin">
										<a href="/HotelManager/web/admin/adminlogin.jsp" class="facebook"><i class="fa fa-facebook"></i><span>Sign in As Admin</span></a>
										<a href="/HotelManager/web/user/userlogin.jsp" class="google-plus"><i class="fa fa-google-plus"></i><span>Sign in As User</span></a>
									</div>
								</div>
