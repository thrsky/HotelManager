					  ...
					  <div class="container">
							  ...
							  <div class="col-md-4 col-md-offset-1">
										  ...
										  <div class="form-group">
												<div class="un-wrap">
													<i class="fa fa-user"></i>
											  			<input type="text" class="form-control" placeholder="name" name="UserName" id="UserName" required="required">
												</div>
												<div class="pw-wrap">
													<i class="fa fa-lock"></i>
											  			<input type="password" class="form-control" placeholder="Password" name="userPassword" id="Password" required="required">
												</div>
								...
								<div class="col-md-4">
									<div class="sns-signin">
										<a href="../admin/adminlogin.jsp" class="facebook"><i class="fa fa-facebook"></i><span>管理员登录</span></a>
										<a href="../worker/workerlogin.jsp" class="google-plus"><i class="fa fa-google-plus"></i><span>工作人员登录</span></a>
									</div>
								</div>
							...
							<div class="row top-buffer bottom-wrap">
								<div class="col-xs-6 col-md-2 col-md-offset-1">
									<a href="/hotelManager/web/user/forgetPassword.html" id="forgot_from_2">忘记密码</a>
								</div>
								<div class="col-xs-6 col-md-2">
									<a href="/HotelManager/web/user/userRegister.jsp" id="signup_from_2">创建新的账户</a>
								</div>
							</div>
						</div>
					</div>
